...
def create_system_overview_diagram():
    ...
    ax.text(
        8,
        9.5,
        "MVSEC Anomaly Detection System Architecture",
        fontsize=20,
        fontweight="bold",
        ha="center",
    )
    ...
    for model, pos in zip(models, model_positions, strict=False):
    ...
    plt.tight_layout()
    plt.savefig(
        "/Users/eahmmoe/localWorkSpace/kth/anomly-detection/system_architecture.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
...
def create_data_flow_diagram():
    ...
    ax.text(
        9,
        11.5,
        "MVSEC Data Processing Pipeline",
        fontsize=20,
        fontweight="bold",
        ha="center",
    )
    ...
    ax.text(
        9, 0.4, "3. Inject artificial anomalies for supervised learning", fontsize=11
    )
    ax.text(
        9,
        0.1,
        "4. Train neural networks to distinguish normal vs anomalous patterns",
        fontsize=11,
    )

    plt.tight_layout()
    plt.savefig(
        "/Users/eahmmoe/localWorkSpace/kth/anomly-detection/data_flow_diagram.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
...
def create_model_architecture_diagram():
    ...
    fig.suptitle(
        "Neural Network Architecture Comparison", fontsize=20, fontweight="bold"
    )
    ...
    ax1.axis("off")
    ax1.set_title(
        "Spiking Neural Network (SNN)", fontsize=16, fontweight="bold", pad=20
    )
    ...
    ax2.axis("off")
    ax2.set_title(
        "Recurrent Neural Network (RNN)", fontsize=16, fontweight="bold", pad=20
    )
    ...
    ax3.axis("off")
    ax3.set_title(
        "Temporal Convolutional Network (TCN)", fontsize=16, fontweight="bold", pad=20
    )
    ...
    plt.tight_layout()
    plt.savefig(
        "/Users/eahmmoe/localWorkSpace/kth/anomly-detection/model_architectures.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
...
def create_anomaly_strategy_diagram():
    ...
    ax2.add_patch(
        plt.Rectangle((15, 20), 20, 20, fill=False, edgecolor="red", linewidth=2)
    )
    ...
    ax3.add_patch(
        plt.Rectangle((25, 10), 25, 25, fill=False, edgecolor="orange", linewidth=2)
    )
    ...
    ax4.add_patch(
        plt.Rectangle((8, 8), 16, 16, fill=False, edgecolor="white", linewidth=2)
    )
    ...
    plt.tight_layout()
    plt.savefig(
        "/Users/eahmmoe/localWorkSpace/kth/anomly-detection/anomaly_strategy.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
...
def create_evaluation_framework_diagram():
    ...
    ax.text(
        7,
        0.5,
        "Evaluation Strategy: Cross-validation, Statistical Testing, Comparative Analysis",
        ha="center",
        va="center",
        fontsize=12,
        fontweight="bold",
    ...
    plt.tight_layout()
    plt.savefig(
        "/Users/eahmmoe/localWorkSpace/kth/anomly-detection/evaluation_framework.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.show()
